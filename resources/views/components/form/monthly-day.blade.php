...
<div class="mt-4" x-show="frequency === 'monthly'" x-cloak>
    <x-input-label for="day_of_month" :value="__('messages.Day of Month')" />
    ...
    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('messages.Enter a day between 1 and 31') }}</p>
